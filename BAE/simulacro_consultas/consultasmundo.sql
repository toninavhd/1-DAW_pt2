...
--1. Para todos los países mostrar el nombre y las ciudades.

SELECT P.Name, COUNT(*) AS NumCities
FROM Country as P
...
--2. Para todos los países mostrar el nombre y las ciudades.

SELECT Country.Name AS CountryName, COUNT(City.ID) AS CityCount, SUM(City.Population) AS TotalPopulation
FROM Country
...
SELECT CountryLanguage.Language, SUM(CountryLanguage.Percentage) AS TotalPercentage
...
SELECT Country1.Name AS Country1, Country2.Name AS Country2
FROM Country AS Country1
CROSS JOIN Country AS Country2
INNER JOIN CountryLanguage AS CL1 ON CL1.CountryCode = Country1.Code
WHERE CL1.Language = 'Spanish' AND CL1.Language = 'Spanish' AND Country1.Name < Country2.Name

--5 10 Ciudades con más habitantes indicando el nombre del país donde están.

SELECT top 10 City.Name, City.Population, Country.Name
FROM City
INNER JOIN Country 
